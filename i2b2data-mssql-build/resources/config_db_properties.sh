...
# db.type
printf "db.type\n"
sed -i "s#db.type=.*#db.type=sqlserver#g" ./Hivedata/db.properties
sed -i "s#db.type=.*#db.type=sqlserver#g" ./Pmdata/db.properties
sed -i "s#db.type=.*#db.type=sqlserver#g" ./Crcdata/db.properties
sed -i "s#db.type=.*#db.type=sqlserver#g" ./Metadata/db.properties
sed -i "s#db.type=.*#db.type=sqlserver#g" ./Workdata/db.properties
sed -i "s#db.type=.*#db.type=sqlserver#g" ./Imdata/db.properties
...
# db.driver
printf "db.driver\n"
sed -i "s#db.driver=.*#db.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver#g" ./Hivedata/db.properties
sed -i "s#db.driver=.*#db.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver#g" ./Pmdata/db.properties
sed -i "s#db.driver=.*#db.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver#g" ./Crcdata/db.properties
sed -i "s#db.driver=.*#db.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver#g" ./Metadata/db.properties
sed -i "s#db.driver=.*#db.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver#g" ./Workdata/db.properties
sed -i "s#db.driver=.*#db.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver#g" ./Imdata/db.properties

# db.url
printf "db.url\n"
sed -i "s#db.url=.*#db.url=jdbc:sqlserver://localhost:1433;database=$i2b2_db_schema_HIVE#g" ./Hivedata/db.properties
sed -i "s#db.url=.*#db.url=jdbc:sqlserver://localhost:1433;database=$i2b2_db_schema_PM#g" ./Pmdata/db.properties
sed -i "s#db.url=.*#db.url=jdbc:sqlserver://localhost:1433;database=$i2b2_db_schema_CRC#g" ./Crcdata/db.properties
sed -i "s#db.url=.*#db.url=jdbc:sqlserver://localhost:1433;database=$i2b2_db_schema_ONT#g" ./Metadata/db.properties
sed -i "s#db.url=.*#db.url=jdbc:sqlserver://localhost:1433;database=$i2b2_db_schema_WORK#g" ./Workdata/db.properties
sed -i "s#db.url=.*#db.url=jdbc:sqlserver://localhost:1433;database=$i2b2_db_schema_IM#g" ./Imdata/db.properties
